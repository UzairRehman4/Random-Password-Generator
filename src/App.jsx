...
function App() {
  ...
  return (
    <>
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-2 py-2 my-10 text-black bg-gray-400">
        <h1 className="text-blue-600 text-center my-3 p-3 text-2xl">
          Password Generator
        </h1>
